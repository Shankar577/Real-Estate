...
public class Navigation extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.view_gallery) {
            ...
            Intent in = new Intent(this,Testimonials.class);
            startActivity(in);
            ...
            sendIntent.putExtra(Intent.EXTRA_TEXT,
                    "Hey check out my app at: https://play.google.com/store/apps/details?id=com.google.android.apps.plus");//change with your project package
